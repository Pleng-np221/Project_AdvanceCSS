...
const Footer = () => {
  return (
    <footer className="purple-light py-3 md:py-5 mt-auto w-full">
      <div className="max-w-7xl mx-auto px-5 md:px-12 flex justify-between items-center w-full">
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-8 text-white shrink-0">
          ...
          <a href="#" className="flex items-center gap-2 hover:text-purple-200 transition-colors">
            ...
            <span className="font-medium text-[12px] md:text-[15px] tracking-wide">WitchQuiz</span>
          </a>
